...
function PlayButton(props) {
    const {active, createPomodoro} = props;
    
    return (
        <>
            <svg onClick={async ()=>{ active(); console.log("ttttttttttttttttttttttt");createPomodoro();}}
                id="play" className="playButton" xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink" width="98" height="98" viewBox="0 0 98 98">
    <defs>
