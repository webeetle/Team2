            ...
            <div className="modal-content">
                <div className='modal-title'>
                    ...
                    <div className='underline'>
                        <div>                            
                            <input id='title' type="text" placeholder='Send message' className='input-title' />                        
                        </div>   
                    </div>                  
                </div>             
              <textarea id='desc' className='description' placeholder='Send a message to Tony: see you tomorrow?'></textarea>
